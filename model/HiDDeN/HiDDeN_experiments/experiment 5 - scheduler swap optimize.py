# experiment 5 - scheduler swap optimizer
...
optimizer = torch.optim.AdamW(list(enc.parameters()) + list(dec.parameters()), lr=1e-3, weight_decay=1e-4)
...
for epoch in range(NUM_EPOCHS):
    ...
    for images in train_loader:
        ...
        loss.backward()
        optimizer.step()
        scheduler.step(epoch + batches / steps_per_epoch)
