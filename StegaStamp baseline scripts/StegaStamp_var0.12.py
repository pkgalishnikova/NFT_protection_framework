# Improved encoder-decoder (based on the model with 98% stegastamp accuracy)  is modernized HiDDeN core with StegaStamp-inspired enhancements
# 67% of decodign under gaussiian blur
